...
public class CedpsTestContainer extends TestContainer {

    public CedpsTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "com/rtcab/cedps/app.properties",
    ...
    public static class Common extends CedpsTestContainer {

        public static final CedpsTestContainer.Common INSTANCE = new CedpsTestContainer.Common();
